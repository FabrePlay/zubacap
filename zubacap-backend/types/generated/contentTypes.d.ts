...
export interface ApiCapacitacionCapacitacion
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visibilidadCalificaciones: Schema.Attribute.Enumeration<
      ['Solo_Instructor', 'Instructor_y_Supervisor', 'Todos']
    > &
      Schema.Attribute.Required;
  };
}

export interface ApiCodigoInvitacionCodigoInvitacion
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usosActuales: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    usosMaximos: Schema.Attribute.Integer & Schema.Attribute.Required;
  };
}
...
export interface ApiInscripcionInscripcion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    fechaFinalizacion: Schema.Attribute.DateTime;
    fechaInscripcion: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    urlCertificado: Schema.Attribute.String;
  };
}

export interface ApiLeccionLeccion extends Struct.CollectionTypeSchema {
...
export interface ApiNotificacionNotificacion
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mensaje: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    tipo: Schema.Attribute.Enumeration<
      ['Test_Calificado', 'Nuevo_Contenido', 'Anuncio_General']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPreguntaPregunta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    alternativas: Schema.Attribute.Component<'test.alternativa', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    enunciado: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProgresoLeccionProgresoLeccion
  extends Struct.CollectionTypeSchema {
...
export interface ApiProgresoTestAlumnoProgresoTestAlumno
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::codigo-invitacion.codigo-invitacion': ApiCodigoInvitacionCodigoInvitacion;
      ...
      'api::progreso-leccion.progreso-leccion': ApiProgresoLeccionProgresoLeccion;
      'api::progreso-test-alumno.progreso-test-alumno': ApiProgresoTestAlumnoProgresoTestAlumno;
